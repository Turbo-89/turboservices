        ...
        <div className="container mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 py-12 md:grid-cols-2 md:py-16">
          ...
          <div className="flex justify-center md:justify-end">
            {heroImage ? (
              ...
              <div className="h-64 w-64 bg-slate-200 rounded-xl" />
            )}
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="mt-12 rounded-2xl border bg-slate-50 p-6 shadow-sm md:p-8">
          ...
          <p className="mb-5 text-slate-700">
            {cta ||
              "Beschrijf kort het probleem en voeg indien mogelijk een foto toe. Ik koppel snel terug met een concreet tijdsblok."}
          </p>
