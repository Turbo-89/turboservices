...
export const metadata: Metadata = {
  title: "Rook- en geurdetectie in Antwerpen Stad",
...
export default function Page() {
  ...
  const intro =
    "Last van rioolgeur in Antwerpen Stad? Via rook- en geurdetectie sporen wij exact op waar de oorzaak zich bevindt." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");

  const sections = [
  {
    "title": "Rook- en geurdetectie",
    "body": "Last van rioolgeur in Antwerpen Stad? Via rook- en geurdetectie sporen wij exact op waar de oorzaak zich bevindt."
  },
  {
    "title": "Wat we doen",
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Antwerpen Stad snel en zonder breekwerk op." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");
