...
export default function Page() {
  ...
  const sections = [
  {
    ...
    "body": "Last van rioolgeur in Leuven & Dijleland? Via rook- en geurdetectie sporen wij exact op waar de oorzaak zich bevindt."
  },
  {
    "title": "Wat we doen",
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Leuven & Dijleland snel en zonder breekwerk op." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");
