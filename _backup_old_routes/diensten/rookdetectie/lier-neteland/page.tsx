...
export const metadata: Metadata = {
  title: "Rook- en geurdetectie in Lier & Neteland",
...
export default function Page() {
  ...
  const intro =
    "Last van rioolgeur in Lier & Neteland? Via rook- en geurdetectie sporen wij exact op waar de oorzaak zich bevindt." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");

  const sections = [
  {
    "title": "Rook- en geurdetectie",
    "body": "Last van rioolgeur in Lier & Neteland? Via rook- en geurdetectie sporen wij exact op waar de oorzaak zich bevindt."
  },
  {
    "title": "Wat we doen",
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Lier & Neteland snel en zonder breekwerk op." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");
