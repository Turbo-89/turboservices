...
export default function Page() {
  ...
  const intro =
    "Lekkage, verzakking of defecte riolering in Hageland? Turbo Services voert snelle en professionele rioolherstellingen uit." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");

  const sections = [
  {
    "title": "Noodherstellingen",
    "body": "Lekkage, verzakking of defecte riolering in Hageland? Turbo Services voert snelle en professionele rioolherstellingen uit."
  },
  {
    "title": "Wat we doen",
  ...
  const ctaBody =
    "Neem contact op voor een snelle diagnose en herstelling in Hageland." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");
