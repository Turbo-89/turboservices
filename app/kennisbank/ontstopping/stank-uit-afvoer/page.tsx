  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-3 text-slate-700">
        Onaangename geuren wijzen vaak op een droog stankafsluiter, aanslag in de leiding, foutieve ontluchting of een
        lek/open verbinding. Met de juiste volgorde verhelp je het meestal snel.
      </p>
      ...
      <ol className="mt-3 list-decimal space-y-2 pl-5 text-slate-700">
        ...
        <li>
          Controleer ontluchting (borrelen? zie{" "}
      ...
      <p className="mt-3 text-slate-700">
        Bij aanhoudende geur voeren we een <b>gerichte reiniging</b> uit en controleren we met{" "}
        <Link href="/kennisbank/ontstopping/camera-inspectie" className="underline">camera-inspectie</Link> of rooktest op lekken en open verbindingen.
      </p>
