...
export default function Page() {
  const props = {
    ...
    intro: "Verstopte wc, lavabo, douche of hoofdriolering in Scheldeland? Turbo Services lost het op met professionele machines, ook ’s avonds en in het weekend aan hetzelfde tarief.",
    sections: [
  {
    "title": "Ontstoppingen",
  ...
  },
  {
    ...
    ctaBody: "Beschrijf kort het probleem en voeg indien mogelijk een foto toe. Wij koppelen snel terug met een concreet tijdsblok in Scheldeland.",
    ctaButton: "Vraag ontstopping aan →",
    serviceKey: "ontstoppingen",
    heroImageKey: "ontstoppingen-scheldeland",
    heroImagePath: "",
  };
