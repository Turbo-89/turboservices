...
export const metadata: Metadata = {
  ...
  description:
    "Verstopte wc, lavabo, douche of hoofdriolering in Sint-Joost-ten-Node? Turbo Services lost het op met professionele machines, ook 's avonds en in het weekend aan hetzelfde tarief.",
};

export default function Page() {
  const city = "Sint-Joost-ten-Node";
  ...
  const ctaBody =
    "Beschrijf kort het probleem en voeg indien mogelijk een foto toe. Wij koppelen snel terug met een concreet tijdsblok in Sint-Joost-ten-Node.";
