...
export const metadata: Metadata = {
  ...
  description: "Ontstopping van wc, lavabo, douche en hoofdriolering in Kempen Zuid. Turbo Services lost verstoppingen snel en professioneel op, ook 's avonds en in het weekend aan hetzelfde tarief.",
};

export default function Page() {
  const regionKey = "kempen-zuid" as const;
  const regionLabel = "Kempen Zuid";
