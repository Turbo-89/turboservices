...
export default function Page() {
  ...
  {
    "title": "Ontstoppingen",
    "body": "Verstopte wc, lavabo, douche of hoofdriolering in Leuven & Dijleland? Turbo Services lost het op met professionele machines, ook ’s avonds en in het weekend aan hetzelfde tarief."
  },
  {
    "title": "Wat we doen",
