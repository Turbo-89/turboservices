...
export const metadata: Metadata = {
  title: `Ontstoppingen in Herent | Turbo Services`,
  description: `Ontstoppingen in Herent voor verstopte wc's, lavabo's, douches, baden, keukenafvoeren en hoofdrioleringen. Turbo Services werkt snel, gericht en ook 's avonds en in het weekend aan hetzelfde tarief.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Waarmee ik help in Herent",
    "body": "Ik help in Herent bij verstopte wc's, lavabo's, douches, baden, keukenafvoeren en hoofdrioleringen. Ook borrelende leidingen, terugkerend water, geurhinder of afvoeren die traag weglopen wijzen vaak op een onderliggende verstopping die gericht moet worden aangepakt."
  },
  {
  ...
  const commercialLinks = getCommercialLinksForServiceAndCity(serviceKey, "Herent", 4);
