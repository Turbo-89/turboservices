...
export const metadata: Metadata = {
  ...
  description:
    "Verstopte wc, lavabo, douche of hoofdriolering in Kraainem? Turbo Services lost het op met professionele machines, ook 's avonds en in het weekend aan hetzelfde tarief.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Beschrijf kort het probleem en voeg indien mogelijk een foto toe. Wij koppelen snel terug met een concreet tijdsblok in Kraainem.";
