...
export const metadata: Metadata = {
  title: "Ontstoppingen in Denderstreek",
  description: "Ontstopping van wc, lavabo, douche en hoofdriolering in Denderstreek. Turbo Services lost verstoppingen snel en professioneel op, ook 's avonds en in het weekend aan hetzelfde tarief.",
};

export default function Page() {
  const regionKey = "denderstreek" as const;
  const regionLabel = "Denderstreek";
  ...
  const intro =
    "Verstopte wc, lavabo, douche of hoofdriolering in Denderstreek? Turbo Services lost het op met professionele machines, ook 's avonds en in het weekend aan hetzelfde tarief." +
  ...
  const ctaBody =
    "Beschrijf kort het probleem en voeg indien mogelijk een foto toe. Wij koppelen snel terug met een concreet tijdsblok in Denderstreek." +
    (muniText ? "\n\nWerkgebied: " + muniText + " en omgeving." : "");
