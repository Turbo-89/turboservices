...
export const metadata: Metadata = {
  title: `Ontstoppingen in Pajottegem | Turbo Services`,
  description: `Ontstoppingen in Pajottegem voor verstopte wc's, lavabo's, douches, baden, keukenafvoeren en hoofdrioleringen. Turbo Services werkt snel, gericht en ook 's avonds en in het weekend aan hetzelfde tarief.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Waarmee ik help in Pajottegem",
    "body": "Ik help in Pajottegem bij verstopte wc's, lavabo's, douches, baden, keukenafvoeren en hoofdrioleringen. Ook borrelende leidingen, terugkerend water, geurhinder of afvoeren die traag weglopen wijzen vaak op een onderliggende verstopping die gericht moet worden aangepakt."
  },
  {
  ...
  const commercialLinks = getCommercialLinksForServiceAndCity(serviceKey, "Pajottegem", 4);
  ...
  return (
    <DienstPageLayout
      ...
      regionLabel="Pajottegem"
      municipalities={municipalities}
      intro={`Problemen met een verstopte wc, lavabo, douche, bad of hoofdriolering in Pajottegem? Turbo Services voert ontstoppingen uit met professionele apparatuur en een gerichte aanpak. Ook bij terugkerende verstoppingen, borrelende afvoeren of water dat terugkomt via toilet, douche of vloerputjes is snelle tussenkomst belangrijk om bijkomende schade en geurhinder te vermijden.`}
      sections={sections}
      faqs={faqs}
      ctaTitle="Direct hulp nodig bij een verstopping?"
      ctaBody={`Beschrijf kort het probleem en de locatie in Pajottegem. Turbo Services koppelt snel terug met een concreet tijdsvenster en een gerichte aanpak voor de situatie ter plaatse.`}
