...
export const metadata: Metadata = {
  ...
  description: "Ontstopping van wc, lavabo, douche en hoofdriolering in Temse & omstreken. Turbo Services lost verstoppingen snel en professioneel op, ook 's avonds en in het weekend aan hetzelfde tarief.",
};
