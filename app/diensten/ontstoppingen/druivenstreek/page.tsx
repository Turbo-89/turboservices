...
export const metadata: Metadata = {
  title: `Ontstoppingen in Druivenstreek | Turbo Services`,
  description: `Ontstoppingen in Druivenstreek voor verstopte wc's, lavabo's, douches, baden, keukenafvoeren en hoofdrioleringen. Turbo Services werkt snel, gericht en ook 's avonds en in het weekend aan hetzelfde tarief.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Waarmee ik help in Druivenstreek",
    "body": "Ik help in Druivenstreek bij verstopte wc's, lavabo's, douches, baden, keukenafvoeren en hoofdrioleringen. Ook borrelende leidingen, terugkerend water, geurhinder of afvoeren die traag weglopen wijzen vaak op een onderliggende verstopping die gericht moet worden aangepakt."
  },
  {
