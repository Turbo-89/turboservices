...
export const metadata: Metadata = {
  title: "Camera-inspectie in Pajottenland",
  description: "Camera-inspectie van afvoer en riolering in Pajottenland met professionele apparatuur. Ideaal om scheuren, verzakkingen of verstoppingen in detail te lokaliseren.",
};
...
export default function Page() {
  ...
  const intro =
    "Nood aan een professionele camera-inspectie in Pajottenland? Wij brengen exact in beeld waar het probleem zit, zonder hak- of breekwerk." +
  ...
  const ctaBody =
    "Wij brengen uw riolering in Pajottenland exact in beeld en geven een duidelijk advies voor de juiste oplossing." +
    (muniText ? "\n\nWerkgebied: " + muniText + " en omgeving." : "");
