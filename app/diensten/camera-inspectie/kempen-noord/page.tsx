...
export const metadata: Metadata = {
  title: "Camera-inspectie in Kempen Noord",
...
export default function Page() {
  ...
  const intro =
    "Nood aan een professionele camera-inspectie in Kempen Noord? Wij brengen exact in beeld waar het probleem zit, zonder hak- of breekwerk." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");

  const sections = [
  {
    "title": "Camera-inspectie",
    "body": "Nood aan een professionele camera-inspectie in Kempen Noord? Wij brengen exact in beeld waar het probleem zit, zonder hak- of breekwerk."
  },
  {
    "title": "Wat we doen",
  ...
  const ctaBody =
    "Wij brengen uw riolering in Kempen Noord exact in beeld en geven een duidelijk advies voor de juiste oplossing." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");
