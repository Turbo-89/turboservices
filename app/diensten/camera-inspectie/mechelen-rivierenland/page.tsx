...
export const metadata: Metadata = {
  title: "Camera-inspectie in Mechelen & Rivierenland",
  description: "Camera-inspectie van afvoer en riolering in Mechelen & Rivierenland met professionele apparatuur. Ideaal om scheuren, verzakkingen of verstoppingen in detail te lokaliseren.",
};
...
export default function Page() {
  ...
  const intro =
    "Nood aan een professionele camera-inspectie in Mechelen & Rivierenland? Wij brengen exact in beeld waar het probleem zit, zonder hak- of breekwerk." +
  ...
  const ctaBody =
    "Wij brengen uw riolering in Mechelen & Rivierenland exact in beeld en geven een duidelijk advies voor de juiste oplossing." +
    (muniText ? "\n\nWerkgebied: " + muniText + " en omgeving." : "");
