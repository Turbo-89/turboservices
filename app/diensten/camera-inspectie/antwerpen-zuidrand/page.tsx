...
export const metadata: Metadata = {
  ...
  description: "Camera-inspectie van afvoer en riolering in Antwerpen Zuidrand met professionele apparatuur. Ideaal om scheuren, verzakkingen of verstoppingen in detail te lokaliseren.",
};
