...
export const metadata: Metadata = {
  title: `Camera-inspectie in Lier & Neteland | Turbo Services`,
  description: `Camera-inspectie in Lier & Neteland om breuken, verzakkingen, wortelgroei en hardnekkige verstoppingen exact in beeld te brengen. Turbo Services lokaliseert de oorzaak gericht en zonder onnodig breekwerk.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer camera-inspectie zinvol is in Lier & Neteland",
  ...
  return (
    <DienstPageLayout
      ...
      intro={`Camera-inspectie in Lier & Neteland is aangewezen wanneer de oorzaak van een riool- of afvoerprobleem niet duidelijk is of wanneer verstoppingen en geurhinder blijven terugkomen. Turbo Services brengt met camera-inspectie exact in beeld wat er in de leiding gebeurt, zodat verdere stappen technisch onderbouwd kunnen worden genomen.`}
      sections={sections}
      faqs={faqs}
      ctaTitle="Camera-inspectie nodig?"
      ctaBody={`Geef kort door welk probleem zich voordoet in Lier & Neteland. Turbo Services bekijkt of camera-inspectie de juiste stap is en koppelt terug met een concreet voorstel voor diagnose en aanpak.`}
