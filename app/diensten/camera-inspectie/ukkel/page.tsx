...
export const metadata: Metadata = {
  title: `Camera-inspectie in Ukkel | Turbo Services`,
  description: `Camera-inspectie in Ukkel om breuken, verzakkingen, wortelgroei en hardnekkige verstoppingen exact in beeld te brengen. Turbo Services lokaliseert de oorzaak gericht en zonder onnodig breekwerk.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer camera-inspectie zinvol is in Ukkel",
