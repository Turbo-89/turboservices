...
export default function Page() {
  return (
    <DienstPageLayout
      ...
      intro={`Camera Inspectie in Scheldeland nodig? In Boom, Niel, Rumst komen verstoppingen, geurhinder en afvoerproblemen frequent voor door oudere rioleringen en intensief gebruik. Turbo Services zorgt voor snelle en gerichte interventies zonder onnodige kosten.`}
      ...
      faqs={[{"q":"Hoe snel kunnen jullie ter plaatse zijn in Scheldeland?","a":"In de meeste gevallen zijn we dezelfde dag nog ter plaatse in Scheldeland en omliggende gemeenten zoals Boom, Niel, Rumst."},{"q":"Wat kost een camera inspectie?","a":"Je krijgt altijd vooraf een duidelijke prijs. Geen verrassingen achteraf."}]}
    />
  );
}
