...
export const metadata: Metadata = {
  title: `Camera-inspectie in Wommelgem | Turbo Services`,
  description: `Camera-inspectie in Wommelgem om breuken, verzakkingen, wortelgroei en hardnekkige verstoppingen exact in beeld te brengen. Turbo Services lokaliseert de oorzaak gericht en zonder onnodig breekwerk.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer camera-inspectie zinvol is in Wommelgem",
