...
export const metadata: Metadata = {
  ...
  description:
    "Nood aan een professionele camera-inspectie in Wommelgem? Wij brengen exact in beeld waar het probleem zit, zonder hak- of breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij brengen uw riolering in Wommelgem exact in beeld en geven een duidelijk advies voor de juiste oplossing.";
