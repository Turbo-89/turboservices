...
export const metadata: Metadata = {
  title: "Noodherstellingen in Antwerpen Stad",
  description: "Noodherstellingen aan afvoer en riolering in Antwerpen Stad, inclusief lekken, verzakkingen en acute schade. Snelle interventie bij dringende problemen.",
};
...
export default function Page() {
  ...
  const intro =
    "Lek, verzakking of acute schade aan afvoer of riolering in Antwerpen Stad? Turbo Services voert snelle en gerichte noodherstellingen uit om verdere schade en overlast te beperken." +
  ...
  const ctaBody =
    "Neem contact op voor een snelle inschatting en noodherstelling in Antwerpen Stad." +
    (muniText ? "\n\nWerkgebied: " + muniText + " en omgeving." : "");
