...
export const metadata: Metadata = {
  ...
  description: "Noodherstellingen aan afvoer en riolering in Ruppelstreek, inclusief lekken, verzakkingen en acute schade. Snelle interventie bij dringende problemen.",
};
