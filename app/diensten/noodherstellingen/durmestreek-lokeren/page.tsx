...
export const metadata: Metadata = {
  title: "Noodherstellingen in Durmestreek Lokeren",
...
export default function Page() {
  ...
  const intro =
    "Lek, verzakking of acute schade aan afvoer of riolering in Durmestreek Lokeren? Turbo Services voert snelle en gerichte noodherstellingen uit om verdere schade en overlast te beperken." +
  ...
  const sections = [
    ...
    if (idx === 0) {
      return {
        ...s,
        body: s.body + `\n\nActief in Durmestreek Lokeren: ${muniText} en omgeving.`,
      };
    }
    return s;
  });
  ...
  const ctaBody =
    "Neem contact op voor een snelle inschatting en noodherstelling in Durmestreek Lokeren." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");
