...
export const metadata: Metadata = {
  title: `Noodherstellingen in Antwerpen | Turbo Services`,
  description: `Noodherstellingen in Antwerpen bij lekken, breuken, verzakkingen en andere acute schade aan afvoer of riolering. Turbo Services grijpt snel in om verdere schade en uitval te beperken.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer een noodherstelling nodig is in Antwerpen",
