...
export const metadata: Metadata = {
  title: "Noodherstellingen in Antwerpen Noordrand",
  description: "Noodherstellingen aan afvoer en riolering in Antwerpen Noordrand, inclusief lekken, verzakkingen en acute schade. Snelle interventie bij dringende problemen.",
};
...
export default function Page() {
  ...
  const intro =
    "Lek, verzakking of acute schade aan afvoer of riolering in Antwerpen Noordrand? Turbo Services voert snelle en gerichte noodherstellingen uit om verdere schade en overlast te beperken." +
  ...
  const ctaBody =
    "Neem contact op voor een snelle inschatting en noodherstelling in Antwerpen Noordrand." +
    (muniText ? "\n\nWerkgebied: " + muniText + " en omgeving." : "");
