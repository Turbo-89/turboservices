...
export const metadata: Metadata = {
  ...
  description: "Noodherstellingen aan afvoer en riolering in Sint-Niklaas regio, inclusief lekken, verzakkingen en acute schade. Snelle interventie bij dringende problemen.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Neem contact op voor een snelle inschatting en noodherstelling in Sint-Niklaas regio." +
    (muniText ? "\n\nWerkgebied: " + muniText + " en omgeving." : "");
