...
export const metadata: Metadata = {
  ...
  description:
    "Lek, verzakking of acute schade aan afvoer of riolering in Bertem? Turbo Services voert snelle en gerichte noodherstellingen uit om verdere schade en overlast te beperken.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Neem contact op voor een snelle inschatting en noodherstelling in Bertem.";
