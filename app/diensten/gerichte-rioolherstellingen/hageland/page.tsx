...
export const metadata: Metadata = {
  ...
  description:
    "Gerichte rioolherstellingen aan afvoer en riolering in Hageland, inclusief breuken, verzakkingen en lokale schade. Diagnose vooraf en doelgerichte herstelling.",
};
...
export default function Page() {
  ...
  const intro =
    "Lekkage, verzakking of lokale schade aan de riolering in Hageland? Turbo Services voert gerichte rioolherstellingen uit met diagnose vooraf en een doelgerichte aanpak." +
  ...
  const ctaBody =
    "Neem contact op voor een snelle diagnose en gerichte rioolherstelling in Hageland." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");
