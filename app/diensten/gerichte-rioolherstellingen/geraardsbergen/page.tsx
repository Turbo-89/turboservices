...
export const metadata: Metadata = {
  title: `Gerichte rioolherstellingen in Geraardsbergen | Turbo Services`,
  description: `Gerichte rioolherstellingen in Geraardsbergen bij breuken, verzakkingen, lekkages en lokale schade aan afvoer of riolering. Turbo Services herstelt gericht op basis van duidelijke vaststellingen en zonder onnodige uitbreidingen.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer een gerichte rioolherstelling nodig is in Geraardsbergen",
