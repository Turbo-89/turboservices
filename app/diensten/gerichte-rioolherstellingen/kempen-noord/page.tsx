...
export const metadata: Metadata = {
  title: "Gerichte rioolherstellingen in Kempen Noord",
  description: "Gerichte rioolherstellingen aan afvoer en riolering in Kempen Noord, inclusief breuken, verzakkingen en lokale schade. Diagnose vooraf en doelgerichte herstelling.",
};
