...
export const metadata: Metadata = {
  title: "Gerichte rioolherstellingen in Temse & omstreken",
  description: "Gerichte rioolherstellingen aan afvoer en riolering in Temse & omstreken, inclusief breuken, verzakkingen en lokale schade. Diagnose vooraf en doelgerichte herstelling.",
};
