...
export const metadata: Metadata = {
  title: "Gerichte rioolherstellingen in Lier & Neteland",
  description: "Gerichte rioolherstellingen aan afvoer en riolering in Lier & Neteland, inclusief breuken, verzakkingen en lokale schade. Diagnose vooraf en doelgerichte herstelling.",
};
