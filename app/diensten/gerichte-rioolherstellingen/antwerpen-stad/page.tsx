...
export const metadata: Metadata = {
  title: `Gerichte rioolherstellingen in Antwerpen Stad | Turbo Services`,
  description: `Gerichte rioolherstellingen in Antwerpen Stad bij breuken, verzakkingen, lekkages en lokale schade aan afvoer of riolering. Turbo Services herstelt gericht op basis van duidelijke vaststellingen en zonder onnodige uitbreidingen.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer een gerichte rioolherstelling nodig is in Antwerpen Stad",
  ...
  return (
    <DienstPageLayout
      ...
      intro={`Gerichte rioolherstellingen in Antwerpen Stad zijn bedoeld voor situaties waarin schade of defecten in de leiding al gelokaliseerd zijn of via inspectie duidelijk kunnen worden vastgesteld. Turbo Services focust op de echte probleemzone, zodat de herstelling technisch gericht en beheersbaar blijft.`}
      sections={sections}
      faqs={faqs}
      ctaTitle="Gerichte rioolherstelling nodig?"
      ctaBody={`Beschrijf kort welk defect of welke schade zich voordoet in Antwerpen Stad. Turbo Services koppelt snel terug met een voorstel voor diagnose, herstelling en praktische aanpak.`}
