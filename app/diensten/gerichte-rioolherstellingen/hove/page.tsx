...
export const metadata: Metadata = {
  ...
  description:
    "Lekkage, verzakking of lokale schade aan de riolering in Hove? Turbo Services voert gerichte rioolherstellingen uit met diagnose vooraf en een doelgerichte aanpak.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Neem contact op voor een snelle diagnose en gerichte rioolherstelling in Hove.";
