...
export const metadata: Metadata = {
  title: "Gerichte rioolherstellingen in Leuven & Dijleland",
  description: "Gerichte rioolherstellingen aan afvoer en riolering in Leuven & Dijleland, inclusief breuken, verzakkingen en lokale schade. Diagnose vooraf en doelgerichte herstelling.",
};
