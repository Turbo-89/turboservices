...
export const metadata: Metadata = {
  ...
  description:
    "Gerichte rioolherstellingen aan afvoer en riolering in Antwerpen Zuidrand, inclusief breuken, verzakkingen en lokale schade. Diagnose vooraf en doelgerichte herstelling.",
};
...
export default function Page() {
  ...
  const intro =
    "Lekkage, verzakking of lokale schade aan de riolering in Antwerpen Zuidrand? Turbo Services voert gerichte rioolherstellingen uit met diagnose vooraf en een doelgerichte aanpak." +
  ...
  const sections = [
    ...
    if (idx === 0) {
      return {
        ...s,
        body: s.body + `\n\nActief in Antwerpen Zuidrand: ${muniText} en omgeving.`,
      };
    }
    return s;
  });
  ...
  const ctaBody =
    "Neem contact op voor een snelle diagnose en gerichte rioolherstelling in Antwerpen Zuidrand." +
    (muniText ? `\n\nWerkgebied: ${muniText} en omgeving.` : "");
