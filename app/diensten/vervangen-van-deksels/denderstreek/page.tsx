...
export const metadata: Metadata = {
  title: `Vervangen van deksels in Denderstreek | Turbo Services`,
  description: `Vervangen van deksels in Denderstreek voor beschadigde, verzakte of losliggende putdeksels en inspectiedeksels. Turbo Services vervangt en corrigeert deksels gericht, veilig en technisch passend.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer een deksel vervangen moet worden in Denderstreek",
  ...
  return (
    <DienstPageLayout
      ...
      intro={`Vervangen van deksels in Denderstreek is aangewezen wanneer een putdeksel of inspectiedeksel beschadigd, verzakt, losliggend of slecht afsluitend is. Turbo Services beoordeelt de bestaande situatie en zorgt voor een correcte, veilige en duurzame vervanging afgestemd op belasting, aansluiting en praktische omstandigheden ter plaatse.`}
      sections={sections}
      faqs={faqs}
      ctaTitle="Deksel laten vervangen?"
      ctaBody={`Beschrijf kort welk type deksel of putprobleem zich voordoet in Denderstreek. Turbo Services koppelt snel terug met een voorstel voor beoordeling en vervanging.`}
