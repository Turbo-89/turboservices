...
export const metadata: Metadata = {
  title: `Vervangen van deksels in Kempen Zuid | Turbo Services`,
  description: `Vervangen van deksels in Kempen Zuid voor beschadigde, verzakte of losliggende putdeksels en inspectiedeksels. Turbo Services vervangt en corrigeert deksels gericht, veilig en technisch passend.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer een deksel vervangen moet worden in Kempen Zuid",
  ...
  return (
    <DienstPageLayout
      ...
      ctaBody={`Beschrijf kort welk type deksel of putprobleem zich voordoet in Kempen Zuid. Turbo Services koppelt snel terug met een voorstel voor beoordeling en vervanging.`}
