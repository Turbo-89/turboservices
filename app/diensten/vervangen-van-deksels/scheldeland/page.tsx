...
export const metadata: Metadata = {
  title: `Vervangen van deksels in Scheldeland | Turbo Services`,
  description: `Vervangen van deksels in Scheldeland voor beschadigde, verzakte of losliggende putdeksels en inspectiedeksels. Turbo Services vervangt en corrigeert deksels gericht, veilig en technisch passend.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer een deksel vervangen moet worden in Scheldeland",
  ...
  return (
    <DienstPageLayout
      ...
      intro={`Vervangen van deksels in Scheldeland is aangewezen wanneer een putdeksel of inspectiedeksel beschadigd, verzakt, losliggend of slecht afsluitend is. Turbo Services beoordeelt de bestaande situatie en zorgt voor een correcte, veilige en duurzame vervanging afgestemd op belasting, aansluiting en praktische omstandigheden ter plaatse.`}
      sections={sections}
      faqs={faqs}
      ctaTitle="Deksel laten vervangen?"
      ctaBody={`Beschrijf kort welk type deksel of putprobleem zich voordoet in Scheldeland. Turbo Services koppelt snel terug met een voorstel voor beoordeling en vervanging.`}
