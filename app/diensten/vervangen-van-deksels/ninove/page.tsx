...
export const metadata: Metadata = {
  ...
  description:
    "Beschadigd, verzakt of losliggend putdeksel in Ninove? Turbo Services vervangt en corrigeert dit gericht en veilig.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Turbo Services beoordeelt de bestaande situatie in Ninove en zorgt voor een correcte, veilige en duurzame vervanging.";
