...
export const metadata: Metadata = {
  title: `Vervangen van deksels in Druivenstreek | Turbo Services`,
  description: `Vervangen van deksels in Druivenstreek voor beschadigde, verzakte of losliggende putdeksels en inspectiedeksels. Turbo Services vervangt en corrigeert deksels gericht, veilig en technisch passend.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer een deksel vervangen moet worden in Druivenstreek",
  ...
  return (
    <DienstPageLayout
      ...
      ctaBody={`Beschrijf kort welk type deksel of putprobleem zich voordoet in Druivenstreek. Turbo Services koppelt snel terug met een voorstel voor beoordeling en vervanging.`}
