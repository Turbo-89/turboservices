...
export const metadata: Metadata = {
  title: `Vervangen van deksels in Arendonk | Turbo Services`,
  description: `Vervangen van deksels in Arendonk voor beschadigde, verzakte of losliggende putdeksels en inspectiedeksels. Turbo Services vervangt en corrigeert deksels gericht, veilig en technisch passend.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer een deksel vervangen moet worden in Arendonk",
