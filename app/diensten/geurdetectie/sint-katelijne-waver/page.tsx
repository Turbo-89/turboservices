...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Sint-Katelijne-Waver? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Sint-Katelijne-Waver snel en zonder onnodig breekwerk op.";
