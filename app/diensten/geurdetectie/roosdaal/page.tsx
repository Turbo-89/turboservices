...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Roosdaal? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Roosdaal snel en zonder onnodig breekwerk op.";
