...
export const metadata: Metadata = {
  title: "Geurdetectie in Ruppelstreek",
  description: "Geurdetectie en onderzoek van rioolgeur in Ruppelstreek om lekken, foutieve aansluitingen of verborgen defecten in afvoer en riolering vast te stellen.",
};
...
export default function Page() {
  ...
  const intro =
    "Last van rioolgeur in Ruppelstreek? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder onnodig breekwerk." +
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Ruppelstreek snel en gericht op en geven duidelijk advies voor de juiste oplossing." +
    (muniText ? "\n\nWerkgebied: " + muniText + " en omgeving." : "");
