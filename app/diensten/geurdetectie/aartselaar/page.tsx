...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Aartselaar? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Aartselaar snel en zonder onnodig breekwerk op.";
