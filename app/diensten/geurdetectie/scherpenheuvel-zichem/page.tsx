...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Scherpenheuvel-Zichem? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Scherpenheuvel-Zichem snel en zonder onnodig breekwerk op.";
