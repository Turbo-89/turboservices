...
export const metadata: Metadata = {
  title: `Geurdetectie in Lier | Turbo Services`,
  description: `Geurdetectie in Lier bij aanhoudende rioolgeur in badkamer, toilet, keuken of technische ruimte. Turbo Services zoekt gericht naar de bron van de stank zonder blind breekwerk.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer geurdetectie zinvol is in Lier",
  ...
  return (
    <DienstPageLayout
      ...
      intro={`Geurdetectie in Lier is aangewezen wanneer rioolgeur blijft terugkomen zonder dat de oorzaak duidelijk zichtbaar is. Turbo Services onderzoekt gericht waar de geur ontstaat, zodat niet op goed geluk moet worden opengebroken of hersteld. Doel is de bron van het probleem technisch correct te lokaliseren.`}
      sections={sections}
      faqs={faqs}
      ctaTitle="Rioolgeur laten opsporen?"
      ctaBody={`Beschrijf kort waar de geurhinder optreedt in Lier en hoe lang het probleem al aanwezig is. Turbo Services koppelt snel terug met een gerichte aanpak voor opsporing en advies.`}
