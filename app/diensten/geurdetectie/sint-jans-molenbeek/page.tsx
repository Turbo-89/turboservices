...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Sint-Jans-Molenbeek? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Sint-Jans-Molenbeek snel en zonder onnodig breekwerk op.";
