...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Brasschaat? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Brasschaat snel en zonder onnodig breekwerk op.";
