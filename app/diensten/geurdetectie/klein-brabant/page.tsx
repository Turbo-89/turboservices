...
export const metadata: Metadata = {
  title: "Geurdetectie in Klein-Brabant",
  description: "Geurdetectie en onderzoek van rioolgeur in Klein-Brabant om lekken, foutieve aansluitingen of verborgen defecten in afvoer en riolering vast te stellen.",
};
...
export default function Page() {
  ...
  const intro =
    "Last van rioolgeur in Klein-Brabant? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder onnodig breekwerk." +
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Klein-Brabant snel en gericht op en geven duidelijk advies voor de juiste oplossing." +
    (muniText ? "\n\nWerkgebied: " + muniText + " en omgeving." : "");
