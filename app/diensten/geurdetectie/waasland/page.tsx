...
export default function Page() {
  return (
    <DienstPageLayout
      ...
      intro={`Geurdetectie in Waasland nodig? In Sint-Niklaas, Temse, Lokeren komen verstoppingen, geurhinder en afvoerproblemen frequent voor door oudere rioleringen en intensief gebruik. Turbo Services zorgt voor snelle en gerichte interventies zonder onnodige kosten.`}
      ...
      faqs={[{"q":"Hoe snel kunnen jullie ter plaatse zijn in Waasland?","a":"In de meeste gevallen zijn we dezelfde dag nog ter plaatse in Waasland en omliggende gemeenten zoals Sint-Niklaas, Temse, Lokeren."},{"q":"Wat kost een geurdetectie?","a":"Je krijgt altijd vooraf een duidelijke prijs. Geen verrassingen achteraf."}]}
    />
  );
}
