...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Tienen? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Tienen snel en zonder onnodig breekwerk op.";
