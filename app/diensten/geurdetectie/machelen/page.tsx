...
export const metadata: Metadata = {
  title: `Geurdetectie in Machelen | Turbo Services`,
  description: `Geurdetectie in Machelen bij aanhoudende rioolgeur in badkamer, toilet, keuken of technische ruimte. Turbo Services zoekt gericht naar de bron van de stank zonder blind breekwerk.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer geurdetectie zinvol is in Machelen",
  ...
  return (
    <DienstPageLayout
      ...
      intro={`Geurdetectie in Machelen is aangewezen wanneer rioolgeur blijft terugkomen zonder dat de oorzaak duidelijk zichtbaar is. Turbo Services onderzoekt gericht waar de geur ontstaat, zodat niet op goed geluk moet worden opengebroken of hersteld. Doel is de bron van het probleem technisch correct te lokaliseren.`}
      sections={sections}
      faqs={faqs}
      ctaTitle="Rioolgeur laten opsporen?"
      ctaBody={`Beschrijf kort waar de geurhinder optreedt in Machelen en hoe lang het probleem al aanwezig is. Turbo Services koppelt snel terug met een gerichte aanpak voor opsporing en advies.`}
