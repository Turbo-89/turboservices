...
export const metadata: Metadata = {
  title: `Geurdetectie in Wommelgem | Turbo Services`,
  description: `Geurdetectie in Wommelgem bij aanhoudende rioolgeur in badkamer, toilet, keuken of technische ruimte. Turbo Services zoekt gericht naar de bron van de stank zonder blind breekwerk.`,
};
...
export default function Page() {
  ...
  const sections = [
  {
    "title": "Wanneer geurdetectie zinvol is in Wommelgem",
