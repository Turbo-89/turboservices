...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Holsbeek? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Holsbeek snel en zonder onnodig breekwerk op.";
