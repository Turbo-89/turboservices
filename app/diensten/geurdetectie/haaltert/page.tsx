...
export const metadata: Metadata = {
  ...
  description:
    "Last van rioolgeur in Haaltert? Turbo Services spoort gericht op waar de oorzaak zich bevindt, zonder blind breekwerk.",
};
...
export default function Page() {
  ...
  const ctaBody =
    "Wij sporen geurproblemen in Haaltert snel en zonder onnodig breekwerk op.";
